        ...
        <div className='card__body'>
            ...
            <div>
                <div className='title'>What to Expect:</div>
                    ...
                    <div>
                        <div><b>Speed and Accuracy:</b> Discover techniques that enable you to perform calculations 
                    with remarkable speed and precision, empowering you to solve problems mentally 
                    in a fraction of the time.</div>

                    <div><b>Conceptual Understanding: </b>Gain a deeper understanding of the underlying principles
                     behind mathematical operations, allowing you to approach problems with clarity and 
                     confidence.</div>
                    
                    <div><b>Practical Applications:</b> 
                     Explore real-world scenarios where Vedic Maths can be applied, 
                    from everyday calculations to competitive exams and beyond.</div>
            ...
            <div>
                <div className='title'>Who Should Attend:</div>
                    <div>
                    This course is designed for learners of all ages and backgrounds who wish to
